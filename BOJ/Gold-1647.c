...
int main( void )
{
    ...
    while ( startV != NULL )
    {
        ...
        while ( E != NULL )
        {
            ...
            mostWeight = mostWeight > (long long)E->Weight ? mostWeight : (long long)E->Weight;
    ...
    printf( "%lld", totalWeight/2 - mostWeight );
...
void KruskalMST( Graph* G, Graph* MST )
{
    ...
    while ( CurrVertex != NULL )
    {
        ...
        AddVertex( MST, MSTVertices[i] ); // There is only Vertices in MST
